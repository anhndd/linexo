...
public final class DaggerAppComponent implements AppComponent {
  ...
  private Usecase getNamedUsecase2() {
    return AppModule_ProvidePlayUsecaseFactory.proxyProvidePlayUsecase(
        ...
        provideRoomRepositoryProvider.get());
  }

  private Usecase getNamedUsecase3() {
    return AppModule_ProvideChatUsecaseFactory.proxyProvideChatUsecase(
        appModule, provideMessageRepositoryProvider.get());
  }
    ...
    this.provideBoardRepositoryProvider =
        DoubleCheck.provider(
            AppModule_ProvideBoardRepositoryFactory.create(
                builder.appModule, provideNetworkSourceProvider, provideLocalSourceProvider));
