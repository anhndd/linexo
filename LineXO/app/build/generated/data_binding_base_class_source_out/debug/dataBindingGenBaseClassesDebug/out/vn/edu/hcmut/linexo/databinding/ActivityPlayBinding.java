...
public abstract class ActivityPlayBinding extends ViewDataBinding {
  ...
  protected ActivityPlayBinding(DataBindingComponent _bindingComponent, View _root,
      ...
      Button btnMessage, ImageButton btnSend, EditText edtMessage, ImageView imgRobot,
      RecyclerView lstMessage, PlayLayout root, View scoreIcon1, View scoreIcon2,
      ClockView txtClock1, ClockView txtClock2, TextView txtNetwork, RoomNumberView txtRoom,
      TextView txtScore1, TextView txtScore2) {
