...
public class Mapper {
    public static Room convertRoomDB2Room(RoomDB roomDB){
        return new Room(roomDB.getAction(), roomDB.getRoom_number(), roomDB.getBoard() == null ? null : convertDBBoard2Board(roomDB.getBoard()), roomDB.getLast_turn(),
    ...
    public static RoomDB convertRoom2RoomDB(Room room){
        return new RoomDB(room.getAction(), room.getRoom_number(), room.getBoard() == null ? null : convertBoard2DBBoard(room.getBoard()), room.getLast_turn(),
